...
paymentRouter.get("/:bookingId", paymentController.getPaymentByBookingId);
paymentRouter.patch("/update/:paymentId/:paymentStatus", paymentController.updatePaymentStatusByPaymentId);
paymentRouter.get("/esewa/initialize/:paymentId", optionalAuthMiddleware, paymentController.initializeEsewaPayment);
